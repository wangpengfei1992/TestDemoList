...
public class QDSkinManager {
    ...
    public static void changeSkin(int index) {
        QMUISkinManager.defaultInstance(myContext).changeSkin(index);
        QDPreferenceManager.getInstance(myContext).setSkinIndex(index);
    }

    public static int getCurrentSkin() {
        return QMUISkinManager.defaultInstance(myContext).getCurrentSkin();
    }
}
