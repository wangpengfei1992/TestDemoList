...
import com.anker.bluetoothtool.activity.ProductSelectActivity.Companion.IS_BLE
...
class MainActivity : AppCompatActivity() {
    ...
    private val spp by lazy { findViewById<Button>(R.id.spp) }
    private val ble by lazy { findViewById<Button>(R.id.ble) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spp.setOnClickListener {
            ...
            intent.putExtra(IS_BLE, false)
            startActivity(intent)
        }

        ble.setOnClickListener {
            val intent = Intent(this, ProductSelectActivity::class.java)
            intent.putExtra(IS_BLE, true)
            startActivity(intent)
        }
