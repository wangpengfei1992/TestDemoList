...
object BTDeviceHelper {
    ...
    open fun recognizeAnkerDevice(context: Context, productModel: ProductModel, device: BluetoothDevice): AnkerWorkDevice? {
        ...
        LogDeviceE.e("recognizeAnkerDevice",device.address)
        LogDeviceE.e("recognizeAnkerDevice","getSoundCoreDevice productCode -> $productCode")
        ...
        if (!uuids.isNullOrEmpty()) {
            for (uuid in uuids) {
                ...
                LogDeviceE.e("recognizeAnkerDevice",strUuid)
