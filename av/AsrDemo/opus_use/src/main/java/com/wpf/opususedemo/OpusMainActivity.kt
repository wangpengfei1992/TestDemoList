...
class OpusMainActivity : AppCompatActivity(), View.OnClickListener, OpusPlayTask.OnOpusPlayListener {
    private val TAG = javaClass.simpleName
    val APP_PATH: String = Environment.getExternalStorageDirectory().toString() + File.separator + "wpf/AsrDemo" + File.separator
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.opus_main_act)
